...
def get_image(idol_id: int, attribute: str, hash: str):
...
def show(request, idol_id: int, size: str=DEFAULT_IMAGE_SIZE):
    ...
    # 画像データ読み込み
    image = get_image(idol_id, setting['attribute'][idol['rarity']], idol['hash'])
    if image is None:
